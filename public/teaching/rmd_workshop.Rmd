...
Materials, available at <https://github.com/resulumit/rmd_workshop>,<sup>*</sup> have the following structure
...
<sup>*</sup> On GitHub, follow `Code -> Download ZIP` to download.
...
- Create a new RStudio project for the existing<sup>*</sup> directory `.../rmd_workshop/manuscript` from the RStudio menu:

> `File -> New Project -> Existing Directory -> Browse -> .../rmd_workshop/manuscript -> Open`
...
<sup>*</sup> The [links to references](#reference-links), [figures](#figure-links), and [tables](#table-links) are covered later on.
