...
<br>
  - [Part 4](#part4) and [Part 5](#part5) covers how to wait
...
---
## Webpage Source Code &mdash; HTML &mdash; the Root
...
---
## Webpage Source Code &mdash; HTML &mdash; the Head
...
The `<lu>` tag introduces un-ordered lists, while the `<li>` tag defines lists items
