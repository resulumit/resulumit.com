...
# data
df <- read.csv("rmd_workshop_uio_files/images_data/journals.csv") %>% 
...
### Digital Scholarship Center | 24 May 2022
...
- please make your thoughts, questions, or technical problems known
  ...
  - ask your friends: the person sitting next to you, Google
  - use your post-it note to call for our help

---
## The Workshop &mdash; Process &mdash; Schedule

- We have booked time till 15:30

   - with a lunch break between 12:00 and 13:00
...
- The slides are designed for self-study as much as for the workshop
    - *accessible*, in substance and form, to go through on your own
        - today's slides are at <https://resulumit.com/teaching/rmd_workshop_uio.html>
        - slides will remain available at <https://resulumit.com/teaching/rmd_workshop.html>
...
- Create a new RStudio project for the existing workshop directory from the RStudio menu:
...
![](rmd_workshop_uio_files/images_data/window_global_options.png)
...
![](rmd_workshop_uio_files/images_data/window_project_options.png)
...
.pull-right-c[
![](rmd_workshop_uio_files/images_data/yaml.png)
]
...
.pull-right-c[
![](rmd_workshop_uio_files/images_data/yaml.png)
![](rmd_workshop_uio_files/images_data/text.png)
]
...
![](rmd_workshop_uio_files/images_data/yaml.png)
![](rmd_workshop_uio_files/images_data/text.png)
![](rmd_workshop_uio_files/images_data/chunk.png)
]
...
![](rmd_workshop_uio_files/images_data/toolbar.png)

<br>

These include, most impotantly,

- the ![](rmd_workshop_uio_files/images_data/button_knit.png) button to compile .Rmd documents
...
knitr::include_graphics("rmd_workshop_uio_files/images_data/first_rmd.png")
```
...
```{r, echo = FALSE, out.width = "95%"}
knitr::include_graphics("rmd_workshop_uio_files/images_data/yaml_html.png")
```
...
```{r, echo = FALSE, out.width = "95%"}
knitr::include_graphics("rmd_workshop_uio_files/images_data/yaml_latex.png")
```
...
```{r, echo = FALSE, out.width = "95%"}
knitr::include_graphics("rmd_workshop_uio_files/images_data/yaml_pdf.png")
```
...
```{r, echo = FALSE, out.width = "95%"}
knitr::include_graphics("rmd_workshop_uio_files/images_data/yaml_word.png")
```
...
```{r, echo = FALSE, out.width = "95%"}
knitr::include_graphics("rmd_workshop_uio_files/images_data/yaml2.png")
```
...
```{r, echo = FALSE, out.width = "95%"}
knitr::include_graphics("rmd_workshop_uio_files/images_data/yaml3.png")
```
...
knitr::include_graphics("rmd_workshop_uio_files/images_data/yaml4.png")
```
...
```{r, echo = FALSE, out.width = "95%"}
knitr::include_graphics("rmd_workshop_uio_files/images_data/yaml5.png")
```
...
```{r, echo = FALSE, out.width = "95%"}
knitr::include_graphics("rmd_workshop_uio_files/images_data/yaml6.png")
```
...
1) Open `journals.Rmd` and complete the YAML for the mock paper
- take cues from `reproduce_this.pdf` and/or the slides
- `Knit` your `journals.Rmd` and observe the outcome
...
```{r, echo = FALSE, out.width = "95%"}
knitr::include_graphics("rmd_workshop_uio_files/images_data/bib.png")
```
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("rmd_workshop_uio_files/images_data/bib1.png")
```
...
```{r, echo=FALSE, out.width="95%"}
knitr::include_graphics("rmd_workshop_uio_files/images_data/csl.png")
```
...
knitr::include_graphics("rmd_workshop_uio_files/images_data/google_scholar.png")
```
