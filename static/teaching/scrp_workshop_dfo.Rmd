...
- teaching workshops, also on
  ...
  - [creating websites](https://resulumit.com/teaching/rbd_workshop.html)
...
- One full day, on how to automate the process of extracting data from websites
...
- Designed for participants with basic knowledge of R programming language
...
- To start you with acquiring and practising the skills needed 
...
- We are here to help
  ...
  - consult Google, [slides](https://resulumit.com/teaching/scrp_workshop.html), [answer script](https://luzpar.netlify.app/exercises/solutions_dfo.R)
...
- Today's slides are available at <https://resulumit.com/teaching/scrp_workshop_dfo.html>
    
  - will remain accessible after the workshop at <https://resulumit.com/teaching/scrp_workshop.html>
  - might crash for some Safari users
      - use a different browser application


- Having the workshop slides<sup>*</sup> on your own machine might be helpful

  - flexibility to go back and forward on your own
  - ability to scroll across, and copy, long codes on some slides
...
## Solutions &mdash; Download from the Internet

- Solutions to exercises, or links to them, are available online

   - can be downloaded at <https://luzpar.netlify.app/exercises/solutions_dfo.R>
...
<br>
   - it is harmful to the source/others, commercially and/or physically  
<br>
...
1) Check the protocols for <https://dfo.no>
...
```{r, echo=FALSE, out.width="100%"}
knitr::include_graphics("scrp_workshop_files/images_data/sg4.png")
```
...
- start with the related code in the previous slides
   - and add at least 3 new variables    
<br>
...
<br>
- use the `read_html` function to save time
    - using the functions from the `polite` package can require a lot of time for this exercise
